...
export default function AdminApprove() {
    ...
    const fetchStores = async () => {
        try {
            ...
            const { data } = await axios.get('/api/admin/aprove-store', { withCredentials: true })
    ...
    const handleApprove = async ({ storeId, status }) => {
        try {
            ...
            const { data } = await axios.post('/api/admin/aprove-store', { storeId, status }, { withCredentials: true })
            // refresh list
